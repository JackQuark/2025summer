...
ref_T  = np.load("/home/Quark/2025summer/prec/dycore/avgt.npy") # K
ref_qv = np.load("/home/Quark/2025summer/prec/dycore/avgqv.npy") # kg/kg
ref_p  = np.loadtxt("/home/Quark/2025summer/prec/dycore/mean_p_full.txt") / 100 # to hPa
...
def main():
    ...
    for ilat in range(32, 64):
        ...
        qvs = climlab.utils.thermo.qsat(ref_T[:, ilat], ref_p)
        ...
        plt.gcf().savefig(f'/home/Quark/2025summer/prec/LRF/figs/LRF_B_lat{lat[ilat]:05.2f}.png', dpi=150, bbox_inches='tight')
